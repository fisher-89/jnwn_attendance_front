  ...
  effects: {
    * getAccessTokenByAuthCode({
      ...
      const params = {
        ...
        client_id: `${process.env.REACT_APP_OA_CLIENT_ID}`,
        client_secret: `${process.env.REACT_APP_OA_CLIENT_SECRET}`,
        ...payload,
      };
    ...
    * refreshAccessToken({
      ...
      const params = {
        ...
        client_id: `${process.env.OA_PATH.REACT_APP_OA_CLIENT_ID}`,
        client_secret: `${process.env.OA_PATH.REACT_APP_OA_CLIENT_SECRET}`,
        scope: '',
        ...payload,
      };
